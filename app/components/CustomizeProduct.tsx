  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <ul className="flex items-center gap-4">
        ...
        <li className="h-8 w-8 rounded-full ring-1 ring-gray-300 cursor-pointer relative bg-purple-500"></li>
        <li className="h-8 w-8 rounded-full ring-1 ring-gray-300 cursor-not-allowed relative border">
      ...
      <ul className="flex items-center gap-3">
        ...
        <li className="ring-1 bg-black text-white rounded-md py-1 px-4 text-sm cursor-pointer">
          Medium
        </li>
        <li className="ring-1 bg-gray-100 text-primary rounded-md py-1 px-4 text-sm cursor-not-allowed">
          Large
        </li>
      </ul>
    </div>
